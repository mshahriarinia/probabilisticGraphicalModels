...
phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [1 1], isDominant); %AA
phenotypeFactor = SetValueOfAssignment( phenotypeFactor, [2 1],~isDominant); %AA
phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [1 2], isDominant); %Aa
phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [2 2], ~isDominant);%Aa
phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [1 3], ~isDominant);%aa
phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [2 3], isDominant);%aa
